		...
		<el-dialog :title="dialogTitle" 
			...
			<el-form :model="formLeaveData" :label-position="labelPosition" label-width="80px">
				<el-form-item label="姓名">
						<el-select v-model="formLeaveData.user_id" placeholder="姓名" @change="selectChange" :disabled="disabled">
							<el-option v-for="(item, index) in childData" :label="item.real_name" :value="item.user_id" :key="index"></el-option>
						</el-select>
					</el-form-item>
				<el-form-item label="学号">
					...
					<el-form-item label="班级">
							<el-input v-model="formLeaveData.class_no" :disabled="disabled"></el-input>
					</el-form-item>
...
export default {
	...
	methods: {
		load() {
			this.loading = true;
			this.request.post('api/teacher/getLeaveRecord', {
    ...
    //     });
		...
		handleSure() {
			...
			this.request.post('/api/teacher/updateLeaveRecord', {
				...this.formLeaveData
			}).then(res => {
				if (res.code == '200'){
					this.$notify.success({
